...
const deletePromotionalMessage = async (req, res) => {
  if (req.session.user && req.session.role == "agent") {
    const { id } = req.params;
    console.log(id)
    try {
      ...
      const deletedata =await  PromotionalMessage.deleteOne({ _id: id })
      
      req.flash('success', 'Promotional message deleted!')
...
const stripe = require("stripe")(
  "sk_test_51IiQoEFf8T31Y9CNWpaoOFCzVOH3dOfPzIl4BmmQcta4t2ZG8KYCPFDTgloXBsHxVLc9Sjyo4ecy7Zgu9Y8H3sQC00L7nT9uva"
);
